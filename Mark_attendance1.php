...
<script> function fun1() { window.location="Attendance_search1.php"; } </script></br>
</div>
...
<input type="radio" name="subject" value="caed">CAED
...
$query="select * from student where sem=1";
